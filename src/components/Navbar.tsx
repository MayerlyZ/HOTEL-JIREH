  ...
  return (
      <nav className="absolute top-0 left-0 w-full z-50 px-4 py-2 md:py-4 md:px-8">
        <div className="flex items-center justify-between relative">
          ...
          {/* Login Form */}
          {formVisible && (
              <div className="absolute top-full right-0 mt-2 bg-white text-black p-4 rounded shadow-lg w-72 z-50">
                <input
                    type="text"
                    placeholder="Usuario"
                    value={username}
                ...
                <input
                    ...
                    className="w-full mb-2 px-2 py-1 border rounded"
                />
                <a href="#" className="text-sm text-blue-500 block mb-2">¿Olvidaste tu contraseña?</a>
                <button
                    onClick={handleLogin}
